                ...
                <div class="row h-100 justify-content-center align-items-center">
                    <div class="col-10 col-md-8 col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="button" value="Create" onclick="showCreateNewQuestionForm()" class="form-control"
                    ...
                    <div class="col-10 col-md-8 col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="button" value="Create" onclick="showCreateNewQuestionForm()"
                                   class="form-control" id="questionSet" required>
                        </div>
                        <input type="submit" value="Submit" onclick="addQuiz()" class="btn btn-info">
                    </div>
                </div>
...
<script>
    ...
    function ajaxSendQuiz(newQuiz) {
        let httpRequest = new XMLHttpRequest();
        httpRequest.open("Post", "saveNewQuiz", true);
        httpRequest.setRequestHeader("Content-type", "application/json");
        httpRequest.dataType = "json";
        let quizString = JSON.stringify(newQuiz);
